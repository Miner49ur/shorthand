...
function openPopup(assignment) {
            ...
            for (const k of Object.keys(data)) {
              switch (k) {
                ...
                case "dev_env":
                  ...
                  break;
                case "edpuzzle_data":
                  document.edpuzzle_data = data[k];
                  break;
                case "questions":
                  document.questions = data[k];
                  break;
              }
            }
          },
  ...
  let popupMessage = {
    ...
    dev_env: document.dev_env,
    edpuzzle_data: window.__EDPUZZLE_DATA__
  };
  ...
  popup.window.postMessage(popupMessage);
